...
### 项目台账表 (`{s.bitable_table_projects}`)
...
### 供应商表 (`{s.bitable_table_suppliers}`)
字段: 供应商名称, 联系人, 联系电话, 供应品类, 等级, 合作状态, 备注

### 回访记录表 (`{s.bitable_table_visits}`)
...
### 谈单账目表 (`{s.bitable_table_accounting}`)
字段: 客户姓名, 项目名称, 付款节点, 应收金额, 实收金额, 收款日期, 付款方, 付款方式, 状态, 备注
"""
